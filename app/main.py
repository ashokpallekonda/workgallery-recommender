# app/main.py — FINAL, SCALABLE, UNBREAKABLE VERSION
...
app = FastAPI(
    title="WorkGallery Recommender — Production Ready",
    description="Two-tower + LightGBM ranking | Scales to 10M+",
    version="2.0"
)
...
@app.get("/")
async def root():
    return {"message": "WorkGallery Recommender LIVE & SCALABLE", "candidates": len(CAND_DF), "jobs": len(JOB_DF)}